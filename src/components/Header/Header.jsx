    ...
    return (
        <header
            className={` ${SECTION_X_PADDING} ${HEADER_Z_INDEX} 
                         max-[500px]:!p-0 max-[500px]:sticky fixed max-[500px]:top-0  top-6 flex items-center  w-full `}
        >
            <nav
                className={`shadow-1 w-full flex items-center gap-[40px] bg-white max-[500px]:rounded-none rounded-2xl max-[700px]:h-[48px] h-[64px] max-[400px]:px-2 max-[450px]:px-4 max-[500px]:px-6 p-2`}>
                <LogoContainer/>
